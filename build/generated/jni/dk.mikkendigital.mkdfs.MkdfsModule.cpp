...
Persistent<FunctionTemplate> MkdfsModule::proxyTemplate = Persistent<FunctionTemplate>();
jclass MkdfsModule::javaClass = NULL;

MkdfsModule::MkdfsModule(jobject javaObject) : titanium::Proxy(javaObject)
{
}

void MkdfsModule::bindProxy(Handle<Object> exports)
{
	...
	Handle<String> nameSymbol = String::NewSymbol("Mkdfs");
...
Handle<FunctionTemplate> MkdfsModule::getProxyTemplate()
{
	if (!proxyTemplate.IsEmpty()) {
	...
	javaClass = titanium::JNIUtil::findClass("dk/mikkendigital/mkdfs/MkdfsModule");
	HandleScope scope;
...
, javaClass, nameSymbol);
	...
	proxyTemplate->Set(titanium::Proxy::inheritSymbol,
		FunctionTemplate::New(titanium::Proxy::inherit<MkdfsModule>)->GetFunction());
